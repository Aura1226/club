...
import org.donghyun.club.dto.NoteDTO;
import org.donghyun.club.service.NoteService;
...
public class NoteController {
   ...
   @PostMapping(value = "") //정석적인 Rest 방식
   public ResponseEntity<Long> register(@RequestBody NoteDTO noteDTO){
       ...
       //201
       return new ResponseEntity<>(num, HttpStatus.CREATED); //OK만 쓰는게 아니다.... 오늘은 CREATED를 써볼거
   }
